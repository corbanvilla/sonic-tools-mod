...
public class TimeTravelerArmor extends ItemArmor {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if (itemStack.func_77973_b() == Main.timetravelerHelmet) {
			effectPlayer(player, Potion.field_76439_r, 0);
		}
		
		if (itemStack.func_77973_b() == Main.timetravelerChestplate) {
				effectPlayer(player, Potion.field_76444_x, 0);
		}
		
		if (itemStack.func_77973_b() == Main.timetravelerLeggings) {
			effectPlayer(player, Potion.field_76424_c, 0);
		}
		
		if (itemStack.func_77973_b() == Main.timetravelerBoots) {
