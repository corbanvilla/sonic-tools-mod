...
public class ModTools {
	...
	public static void createTools() {
		//Tool Materials
		ToolMaterial Pickaxe = EnumHelper.addToolMaterial("Pickaxe", 4, 10000, 20.0F, 6.0F, 30);
		ToolMaterial Shovel = EnumHelper.addToolMaterial("Shovel", 4, 10000, 20.0F, 6.0F, 30);
		ToolMaterial Axe = EnumHelper.addToolMaterial("Axe", 4, 10000, 20.0F, 7.5F, 30);
		ToolMaterial Sword = EnumHelper.addToolMaterial("Sword", 4, 10000, 2.0F, 15.0F, 30);
		ToolMaterial SonicScrewdriver = EnumHelper.addToolMaterial("SonicScrewdriver", 30, 50000, 40.0F, 40.0F, 100);
