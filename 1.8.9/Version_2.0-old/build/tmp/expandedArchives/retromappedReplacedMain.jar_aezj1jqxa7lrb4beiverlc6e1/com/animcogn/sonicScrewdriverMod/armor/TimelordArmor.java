...
public class TimelordArmor extends ItemArmor {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if (itemStack.func_77973_b() == ModItems.timelordHelmet) {
			effectPlayer(player, Potion.field_76439_r, 1);
		}
		
		if (itemStack.func_77973_b() == ModItems.timelordChestplate) {
			absorbtion(player);
			effectPlayer(player, Potion.field_76420_g, 0);
				
		}
		
		if (itemStack.func_77973_b() == ModItems.timelordLeggings) {
			effectPlayer(player, Potion.field_76424_c, 1);
			effectPlayer(player, Potion.field_76422_e, 0);
		}
		
		if (itemStack.func_77973_b() == ModItems.timelordBoots) {
